...
@sanzope\`\`\``,
  ...
  const menuMessage = `
<blockquote><b>Olâa ${ctx.from.first_name}, Selamat datang di VANTHRA kali ini VANTHRA hadir dengan bug terbaru nya</b></blockquote>
<blockquote><b>⬡═―—⊱ ⎧  ✞︎𓆩𝐕𝐀𝐍𝐓𝐇𝐑𝐀𓆪✞︎ ⎭ ⊰―—═⬡</b></blockquote>
⌬ Developer : @sanzope  
⌬ Username : ${username}
⌬ Version : 1.0.0
⌬ Prefix : /  
...
<blockquote><b>⬡═―—⊱ ⎧  ✞︎𓆩𝐁𝐎𝐓 𝐒𝐓𝐀𝐓𝐔𝐒𓆪✞︎ ⎭ ⊰―—═⬡</b></blockquote>
...
© VANTHRA New Era`;
  ...
  const keyboard = [
    ...
    [
      { text: "⌜🕷⌟ Developer", url: "t.me/sanzope", style: "success"},
...
〣 /crotmas - Delay spam V2</b></blockquote>`;
    ...
    const keyboard = [
        [
            ...
            {
                text: "⌜🔜⌟ 𝗕𝘂𝗴 𝗠𝗲𝗻𝘂 𝗩𝟮", callback_data: "/bug3", style: "Success"
            }
        ]
    ];
